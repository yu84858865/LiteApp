...
public class CourseLiveAdapter extends RecyclerView.Adapter<CourseLiveAdapter.ViewHolder> {
    ...
    public void addData(List<CourseLiveBean> list){
        if (list!=null){
    ...
    @Override
    public CourseLiveAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(CourseLiveAdapter.ViewHolder holder, int position) {
        CourseLiveBean bean = mList.get(position);
